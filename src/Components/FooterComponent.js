  ...
  return (
    <div className="footer bg-primary">
      <div className="container">
        <div className="row ">
          <div className="col-xl-2 col-md-2 col-sm-12 text-black mt-4">
            <h5>Links</h5>
            <ul className="list-unstyled">
              ...
              <li>
                <Link style={{ color: "blue" }} to="/aboutus">
                  About Us
                </Link>
              </li>
              <li>
                <Link style={{ color: "blue" }} to="/menu">
                  Menu
                </Link>
              </li>
              <li>
                <Link style={{ color: "blue" }} to="/contactus">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div className="col-xl-5 col-md-5 col-sm-12 align-self-center">
